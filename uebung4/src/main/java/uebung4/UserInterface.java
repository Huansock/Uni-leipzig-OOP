 ...
 * <p>
 * wenn Sie alls selbst eingeben möchten, benutzen Sie diese UserInterface
 * <p>
 *
...
public class UserInterface {
  ...
  /**
   * Schlie&szlig;t den InputStream {@code System.in}. Nach dem Schlie&szlig;en
   * sind keine Konsoleneingaben mehr m&ouml;glich.
   *
   * @throws UserInterfaceException falls {@code System.in} bereits geschlossen
   *                                wurde.
   */
  public void close() {
    try {
  ...
  /**
   * Fordert den Nutzer auf eine Ganzzahl (&gt;= {@code minimum} &amp; &lt;=
   * {@code maximum}) einzugeben.
   * <p>
   * Beispielnutzung:
   * <p>
   * <code>
  ...
  /**
   * Fordert den Nutzer auf eine Flie&szlig;kommazahl (&gt;= {@code minimum})
   * einzugeben.
   * <p>
   * Beispielnutzung:
   * <p>
   ...
   *
   * @param message       anzuzeigende Nachricht mit Aufforderung
   * @param choiceOptions m&ouml;gliche Optionen ({@code Array} oder
   *                      {@code Sequenz von Argumenten})
   * @return int - Index der gew&auml;hlten Option
   * @throws UserInterfaceException falls keine {@code choiceOptions}
  ...
  /**
   * Fordert den Nutzer auf eine Konsoleneingabe als Antwort auf eine Ausgabe zu
   * machen.
   * <p>
   * Beispielnutzung:
   * <p>
  ...
  /**
   * Spezialisierte Exception w&auml;hrend der Verwendung vom
   * {@link UserInterface}.
   * Erbt von {@link RuntimeException} und geh&ouml;rt somit zu den
   * <i>unchecked</i> Exceptions.
   *
   * @author Nicolas Handke
   * @version 1.3
   * @since JDK1.8
  ...
  public static class UserInterfaceException extends RuntimeException {
     ...
     *
     * @param message die Fehlernachricht (welche f&uuml; das sp&auml;tere Auslesen
     *                mit der Methode {@link java.lang.Throwable#getMessage()}
     *                gespeichert wird).
     */
